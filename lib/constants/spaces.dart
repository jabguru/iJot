...
const kVLargeVSpace = SizedBox(height: 55.0);
const kFullHSpace = SizedBox(width: 16.0);
const kHalfHSpace = SizedBox(width: 8.0);
const kLargeHSpace = SizedBox(width: 32.0);
const kQuarterHSpace = SizedBox(width: 4.0);
const kHSpace6 = SizedBox(width: 6.0);
