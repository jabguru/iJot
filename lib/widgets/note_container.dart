...
class NoteContainer extends StatefulWidget {
  final Note note;
  final int noteIndex;
  const NoteContainer(this.note, this.noteIndex, {super.key});
              ...
              content: Column(
                ...
                children: [
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: const TextStyle(color: kGrey1, fontSize: 12.0),
                  ),
                  kVSpace26,
                  Row(
    ...
    return GestureDetector(
      onTap:
          () => context.go(
            ...
            extra: {'note': widget.note},
          ),
      child: MouseRegion(
        cursor: SystemMouseCursors.click,
        child: Container(
          margin: EdgeInsets.only(bottom: screenGreaterThan700 ? 20.0 : 8.0),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(fontSize: 11.0, height: 1.18),
                        ),
                      ],
                    ),
                    Row(
